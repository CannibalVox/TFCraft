...
class EntityAIAvoidEntitySelectorTFC
{
	 ...
	 */
	public boolean filter(Entity par1Entity)
	{
		...
		Vec3d distanceVec = creature.getPositionVector().subtract(par1Entity.getPositionVector());
		...
		Vec3d movement = new Vec3d(par1Entity.motionX, par1Entity.motionY, par1Entity.motionZ);
